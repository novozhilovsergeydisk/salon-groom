...
fbq('init', '6568225839919373');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=6568225839919373&ev=PageView&noscript=1"
/></noscript>
...
{{--                </div>--}}
                            ...
                            <div class="slide-info">
                                ...
                                <div class="slider-title">
                                    ...
                                    <div class="doc">
                                        ...
                                        <div class="div-master">Основатель салона груминга. Мастер-универсал, фанат своего дела. Хозяйка двух красивых ротвейлеров Марты и Джохара. Карина умеет находить подход к любому
                                            хвостику - и к собаке крупных размеров, и к маленькому питомцу. Регулярно посещает семинары по повышению квалификации. Помимо выполнения процедур для красоты и здоровья вашего
                                            любимца консультирует по вопросам ухода и содержания.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="slide-info">
                                ...
                                <div class="slider-title">
                                    ...
                                    <div class="doc">
                                        ...
                                        <div class="div-master">В груминге относительно недавно - чуть более 2 лет. Молодая, активная, Светлана любит свою профессию и горит желанием развиваться. Если понаблюдать за работой
                                            мастера со стороны, видно с каким усердием она подходит к любому нюансу. Света очень хочет стать лучшей в профессии, и мы ее в этом поддерживаем.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="mobile-margin-top">
                    ...
                    <div class="text-center main-font" style="margin: 20px">
                        ...
                        <button id="btn-express-molt" class="tab-btn">Экспресс-линька </button>
                        <button id="btn-cats" class="tab-btn">Кошки </button>
                    ...
                    <div class="row main-font">
                        <div id="complex" class="col-md-12 tabs-price">
                            ...
                            <table class="table table-dark-alt table-hover">
                                ...
                                <tr>
                                    ...
                                    <th><span class="col-price hidden">Цена</span> <i class="fa fa-arrow-circle-down fs-25"></i></th>
                                </tr>
                                </thead>
                            ...
                            <table class="table table-dark-alt table-hover">
                                ...
                                <tr>
                                    ...
                                    <th><span id="col-price-2" class="col-price hidden">Цена</span> <i id="col-price-arrow-2" class="fa fa-arrow-circle-down fs-25"></i></th>
                                </tr>
                                </thead>
                        ...
                        <div id="hygiene" class="col-md-12 tabs-price hidden">
                            ...
                            <table class="table table-dark-alt table-hover">
                                ...
                                <tr>
                                    <th class="width-80-persent">Мелкие породы</th>
                                    <th><span class="col-price hidden">Цена</span> <i
                                                                                                       class="fa fa-arrow-circle-down fs-25"></i></th>
                                </tr>
                                </thead>
                        ...
                        <div id="express-molt" class="col-md-12 tabs-price hidden">
                            ...
                            <table id="express-molt-middle" class="table table-dark-alt table-hover">
                        ...
                        <div id="cats" class="col-md-12 tabs-price hidden">
                            <table class="table table-dark-alt table-hover">
                                <thead>
                                <tr>
                                    <th>Услуги</th>
    ...
    <div class="about-us" id="sec6">
        <div class="container">
            <div class="title white">О нас</div>
            <hr>
            <div class="row">
                <div>
                    <p>
                        Предлагаем вашему вниманию услуги профессионального груминга в Москве. Процедуры по уходу за кожей,
                        шерстью, когтями собаки будут полезны в гигиенических целях и при подготовке питомца к выставке.
                        <br />Благодаря заботе внимательного владельца и опытных мастеров нашего салона улучшатся здоровье и качество жизни домашних любимцев.
                    </p>
                    ...
                    <ul class="list-about">
                        <li>мытье и сушку;</li>
                        <li>удаление лишней шерсти (стрижку ножницами и машинкой, ручной тримминг);</li>
                        <li>чистку ушей;</li>
                        <li>процедуры по общей гигиене;</li>
                        <li>стрижку когтей и др.</li>
                    </ul>

                    <p>
                        Специалисты Груминг салона No 1 удовлетворят любые пожелания гостей.
                        Стрижка собак и другие манипуляции проводятся крайне бережно.
                        <br />Наша задача - не только качественно
                        выполнить необходимые процедуры, но и обеспечить четвероногим клиентам и их
                        владельцам максимальный комфорт.
                    </p>

                    <p>Во время процедур груминга к вашим услугам:</p>

                    <ul class="list-about">
                        <li>уютная зона отдыха;</li>
                        <li>горячие напитки;</li>
                        <li>бесплатный wi-fi;</li>
                        <li>возможность просмотра телевизионных программ на большом экране.</li>
                    </ul>

                    <p>
                        Кроме процедур для собак мы разработали специальные комплексы для кошек. Вы можете ознакомиться с отзывами наших гостей и записаться на груминг прямо на сайте.</div>
                    </p>
