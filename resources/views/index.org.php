...
<head>
    ...
    <!-- CSS style -->
    <link rel="stylesheet" href="/public/css/nova.css">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark transparant" style="background-color: #6f42c1;">
        <div class="container">
            <a class="navbar-brand absolute" href="/">
                ...
                {{--                <img class="w-72" src="/public/img/org/logo-new.png" alt="logo">--}}
            </a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 color-common" style="font-size: 17px !important;">
                ...
                <strong><i>Это история о том, как три мастера открыли салон груминга.</i></strong>

                <i>Каждая из наших мастеров (Карина, Светлана и Марина) долго шли к этой цели: начинали по разному, кто-то ездил и оказывал услуги на дому, кто-то работал в салоне. Это был непростой, но очень интересный и познавательный путь - становления в профессии. Мы абсолютно уверены в том, что человек с «холодным» сердцем не сможет работать в этой профессии. Животные его не примут.
                </i>

                <i>Нам пришлось пройти через все бюрократические процедуры открытия своего дела. Для нас это первый и удачный опыт. Мы очень рады своим постоянным клиентам, которые у нас появились за прошедший период работы, и мы очень рады нашим новым клиентам, которые впервые доверили нам своих любимцев.
                </i>

                <strong><i>Мы будем стараться для Вас! Приходите в наш салон. Животные будут рады.</i></strong>
    ...
    <div class="container">
        <div class="row main-font">
            ...
            <div class="col-md-4 mb-5">
                ...
                <p style="margin-top: -30px !important; margin-left: -10px;">
                    <a href="https://instagram.com/salongroom1?igshid=1pvyxcewbq2yq" class="p-2" target="_blank" title="Наши работы в Instagram">
                        {{--                        <span style="font-size: 25px;" class="fa fa-instagram"></span>--}}
                        <img src="/public/img/icons/instagram.png" alt="icon" style="width: 32px;">
